...
if( __name__ == "__main__"):    
    ...
    output_file = open("Z_Scan_test_1.csv", "w+")
    ...
    distanceArray = [0]*NUMBER_OF_AVERAGES
    distanceSum = 0
    i = 0
    """-- MAIN LOOP --"""
    while True:
